...
// Components
const SidebarPatient = React.lazy(() =>
  import("../../components/Sidebar/SidebarPatient")
);
const SidebarAdmin = React.lazy(() =>
  import("../../components/Sidebar/SidebarAdmin")
);
const SidebarClinician = React.lazy(() =>
  import("../../components/Sidebar/SidebarClinician")
);

const MenuDropdownPatient = React.lazy(() =>
  import("../../components/Layout/PatientMenu")
);
const MenuDropdownAdmin = React.lazy(() =>
  import("../../components/Layout/AdminMenu")
);
const MenuDropdownClinician = React.lazy(() =>
  import("../../components/Layout/ClinicianMenu")
);
        ...
        <div className="d-flex flex-md-row flex-column flex-nowrap vh-100">
          ...
          <div className="container-fluid bg-white w-100 h-auto border overflow-auto">
            ...
            <div className="row h-100">
              {/* FIRST COL */}
              <div
                className={`col-sm bg-white ${
                  !contentData?.videoUrl ? "col-12" : ""
                }`}
              >
                    ...
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: DOMPurify.sanitize(
                          contentData?.description || "Description here"
                        ),
                      }}
                    />
                  </div>
